<!-- SLIDE 12 — CAPITAL ASK & USE OF PROCEEDS -->
<section data-transition="convex" data-background-color="#1a2266" class="sports-topbar sports-bottombar sports-glow-center">
  ...
  <div style="position: relative; z-index: 1;">
    ...
    <div class="fly-up delay-3" style="max-width: 600px; margin: 20px auto 0; text-align: left;">
      ...
      <ul style="font-size: 0.4em; line-height: 2; color: #E8ECF4; list-style: none; padding: 0; column-count: 2; column-gap: 25px;">
        <li>&#9654; Corporate infrastructure</li>
        <li>&#9654; Media &amp; broadcast buildout</li>
        <li>&#9654; Brand launch &amp; national marketing</li>
        <li>&#9654; Technology development</li>
        <li>&#9654; Sponsorship sales team expansion</li>
        <li>&#9654; Course engineering &amp; venue agreements</li>
        <li>&#9654; Working capital reserve</li>
      </ul>
    </div>
    <p style="font-size: 0.42em; color: #B8C4E0; margin-top: 15px; font-style: italic;">Institutional capital remains separate from event cash flow.</p>
  </div>
</section>
