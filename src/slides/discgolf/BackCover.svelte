...
<section data-auto-animate data-auto-animate-unmatched="fade" data-background-color="#0a0a0a">
  <img src="assets/fli_logo.png" alt="FLI Golf League" style="height: 150px; margin-bottom: 15px;" />
  ...
  <p class="fragment fade-up" style="font-size: 0.35em; color: #555; margin-top: 30px;">Confidential Presentation &mdash; February 2026</p>
</section>
